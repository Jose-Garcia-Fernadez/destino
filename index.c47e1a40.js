...
function cargar_nazare_h(incremento, parametro) {
    ...
    if (w > 600) {
        listado = (0, _listadosJs.l).fotos.nazaree_png_600_1;
        c = " mediana ";
    }
    if (w > 1000) {
        listado = (0, _listadosJs.l).fotos.nazaree_png_900_1;
        c = " grande ";
    }
    switch(parametro){
        case 1:
            ...
            h3.innerHTML = "Presentaci\xf3n: fotos de Nazar\xe9 ";
            break;
        case 2:
            break; // ????
    }
...
},{"/src/12-js/listados.js":"1pr6H","/src/12-js/debug.js":"ct35Q"}]},["2xlZs","hNfZx"], "hNfZx", "parcelRequire3c64")

//# sourceMappingURL=index.c47e1a40.js.map
